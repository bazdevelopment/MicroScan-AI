...
<head>
  ...
  <title>MicroScan AI - Verification Code</title>
  <style>
    body {
...
<body>
  ...
  <div class="logo-container">
    <div class="logo-wrapper">
      <img src="https://firebasestorage.googleapis.com/v0/b/x-ray-analizer-dev.firebasestorage.app/o/assets%2Ficon_transparent.png?alt=media&token=968f8335-f92e-48e7-8276-778961a34dc7" alt="MicroScan AI Logo">
    </div>
    </div>
    <h1>MicroScan AI</h1>
    ...
    <div class="content">
      ...
      <p>Thank you for using <strong>MicroScan AI</strong>. To complete your verification, please use the following 6-digit code:</p>
    ...
    <!-- Footer Section -->
    <div class="footer">
      <p>If you have any questions, feel free to <a href="mailto:microscanaiapp@gmail.com">contact us</a>.</p>
      <p>&copy; 2025 MicroScan AI. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
