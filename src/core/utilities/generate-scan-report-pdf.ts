...
<body>
    <div class="container">
        ...
        <footer style="text-align: center; padding: 20px; color: #64748B; font-size: 12px; border-top: 1px solid #E2E8F0; margin-top: 100px;">
            ...
            <p style="margin: 0;">The AI-generated results from MicroScan AI are intended for informational purposes only and should not be used as a substitute for professional medical advice. Always seek guidance from a qualified healthcare professional for diagnosis and treatment.</p>
        </footer>
    </div>
</body>
</html>
